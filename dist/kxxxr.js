(function (global, factory) {
	...
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.Kxxxr = {}));
...
void main() {
	 ...
	 */
	function waterHoverEffect(canvas, options = {}) {
  ...
  `;
	 ...
	 * @returns {() => void} dispose
	 */
	function realisticWaterHoverEffect(canvas, options = {}) {
	  const {
	    imageUrl,
	  ...
	  const rtA = new WebGLRenderTarget(renderWidth, renderHeight, params);
	  const rtB = new WebGLRenderTarget(renderWidth, renderHeight, params);
	  let ping = rtA,
	    pong = rtB;
	  ...
	  imageTex.minFilter = LinearFilter;
	  imageTex.magFilter = LinearFilter;
	  imageTex.flipY = true;
	  imageTex.generateMipmaps = false;

	  // Mouse uniforms
	  let mouse = new Vector4(-100, -100, 0, 0); // x, y, z=2.0 if hover, 0.0 if not
	  ...
	  const physicsMaterial = new ShaderMaterial({
	    uniforms: {
    ...
    `,
	  ...
	  const finalCamera = new OrthographicCamera(-1, 1, 1, -1, 0, 1);
	  const finalQuad = new Mesh(
	    new PlaneGeometry(2, 2),
	    displayMaterial
	  );
  ...
  `;
	...
	exports.cleanupKxxxrEffects = cleanupKxxxrEffects;
	exports.fluidSimulationEffect = fluidSimulationEffect;
	exports.glitchEffect = glitchEffect;
	exports.initKxxxrEffects = initKxxxrEffects;
	exports.realisticWaterHoverEffect = realisticWaterHoverEffect;
	exports.reinitKxxxrEffects = reinitKxxxrEffects;
	exports.waterHoverEffect = waterHoverEffect;
